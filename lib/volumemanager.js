...
class VolumeManager {
    ...
    init(config = {}) {
         ...
         * with an external storage syste like S3.
         */
        this.drivers = {};
     ...
     * @param {Object} options Volumne configuration options
     * @param {String} options.protocol Driver identfifier
